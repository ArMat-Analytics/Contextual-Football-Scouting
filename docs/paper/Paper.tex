...
\midrule
\cref{fig:xpass-shap} & \texttt{xpass\_shap.png} & H2 xPass (SHAP) & \cref{sec:model-selection} \\ \midrule
\cref{fig:h1-radar} & \texttt{h1\_radar\_kimmich.png} & H1 card & \cref{sec:h1-findings} \\ \midrule
\cref{fig:bolla-linebreaker} & \texttt{linebreaking\_pass\_1.png} & H1 line-breaker & \cref{sec:h1-findings} \\ \midrule
...
\cref{fig:dq-vs-value-impact} & \texttt{dq\_vs\_value\_impact.png} & H2 validation & \cref{sec:dq-index} \\ \midrule
...
\cref{fig:urs-split-half} & \texttt{urs\_split\_half.png} & H3 validation & \cref{sec:h3-validation} \\ \midrule
